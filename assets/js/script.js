...
function start() { // Inicio da função start()
  ...
  function movefundo() {
    ...
    $("#fundoGame").css("background-position", esquerda - 1.5);
  ...
  function moveinimigo1() {
    ...
    $("#inimigo1").css("left",posicaoX-velocidade1);
  ...
  //Função GAME OVER
    ...
    somGameover.addEventListener("ended", function() { somGameover.currentTime = 0; somGameover.play(); }, false);
    somGameover.play();
    ...
    $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi:</p><h1>" + pontos + "</h1>" + "<div><h3 id='reinicia' onClick=reiniciaJogo()>Jogar Novamente</h3><h3 id='irMenuPrincipal' onClick=menuPrincipal()>Ir para o menu principal</h3></div>");
